...
- Kept locally, gitignored: `.planning/local/sweep-mainbase-122-2026-09-07/*.json`.
- This directory is one half of issue **#122**'s two-run GATE-03 pair. The other half is
  `sweep-after-122-2026-09-07/`; see the "#122" section of `../04-SWEEP.md` for the two-directional adjudication.
